    ...
    return (
        <div className='justtify-center items-center m-2 p-2 border-2 rounded-xl w-72  bg-gray-200'>
            <section className="items-center justify-center flex-col gap-4 p-4 flex-wrap ">
                <img src={gambar} className='w-[200px] h-[200px] object-contain bg-inherit'/>
                <div>
                    ...
                    <button onClick={() => navigate("/detail")} className='text-center flex rounded-xl px-2 border-2 border-gray-500 hover:bg-green-600 transition'>Beli</button>
                </div>
            </section>
        </div>
    );
